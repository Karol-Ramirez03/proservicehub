package com.servimax.proservicehub.config.security.authorization;
...
import com.servimax.proservicehub.infrastructure.repository.operation.OperationRepository;
...
public class CustomAuthorizationManager implements AuthorizationManager<RequestAuthorizationContext> {
    ...
    private List<Operation> obtainOperations(Authentication authentication) {
        ...
        return user.getRol().getPermissions().stream()
